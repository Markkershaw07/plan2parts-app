...
## 1. First-time setup â€” create trapeze templates
...
4. Add items **per trapeze**: threaded rod, bracket, fixings â€” with qty and unit.
...
3. Click **Create Job** â€” you land on the Setup tab.
...
4. Results appear below â€” one card per detected tray system.
...
When happy, click **Save to Job** â€” you return to the Setup tab.
...
- Set up templates once â€” reuse them across all jobs.
...
- Set `OPENAI_API_KEY` in Vercel environment variables before deploying.
